...
export const extra = {
  en: {
    ...
    routeDetail: {
      ...
      notesTitle: 'Good to know on this route',
      guideCta: 'Read the full guide',
      routeFaqTitle: 'Questions about this route',
      departureNote:
        'Flying out? Allow about {min} minutes on the road, plus the two hours your airline asks for at check-in. Tell us your flight time and we set the pickup hour for you.',
  ...
  tr: {
    ...
    routeDetail: {
      ...
      aboutTitle: 'Bu transfer hakkında',
      notesTitle: 'Bu güzergahta bilmeniz gerekenler',
      guideCta: 'Rehberin tamamını okuyun',
      routeFaqTitle: 'Bu güzergaha dair sorular',
      departureNote:
        'Uçuşa mı gidiyorsunuz? Yolda yaklaşık {min} dakika, üstüne havayolunun istediği iki saatlik check-in payını bırakın. Uçuş saatinizi söyleyin, alış saatini biz ayarlayalım.',
  ...
  ru: {
    ...
    routeDetail: {
      ...
      aboutTitle: 'Об этом трансфере',
      notesTitle: 'Что полезно знать на этом маршруте',
      guideCta: 'Читать полный гид',
      routeFaqTitle: 'Вопросы по этому маршруту',
      departureNote:
        'Летите обратно? Заложите около {min} минут на дорогу плюс два часа, которые авиакомпания просит на регистрацию. Назовите время вылета — час подачи рассчитаем мы.',
