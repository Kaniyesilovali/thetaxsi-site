...
description: "Гид по такси в Гюзельюрте: поездки по городу по фиксированной цене, за город — в Никосию, Кирению и аэропорт Эрджан, и студенческое такси."
---
...
<h2>Студенческое такси: из общежития в кампус</h2>
